                    ...
                    foreach ($terms as $term) {
                        ...
                        <li>
                            <div class="banner-details">
                                <div class="banner-icon"><a href="<?php echo get_term_link($term->slug, $taxonomy) .'&properties_status='.$_GET['properties_status']; ?>"><img src="<?php echo $icon['url']; ?>" class="img-responsive" alt=""></a></div>
                                <h3 class="banner-title"><a href="<?php echo get_term_link($term->slug, $taxonomy) .'&properties_status='.$_GET['properties_status']; ?>"><?php echo $term->name; ?></a></h3>
                            </div>
                        </li>
